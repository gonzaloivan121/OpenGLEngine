...
public:
	...
	/**
	 * Called when the layer is created. This is where you can initialize resources or set up state for the layer.
	 * By default, this method does nothing, but derived classes can override it to perform specific actions when the layer is created.
	 * 
	 * @note This method is called once when the layer is created, and will not be called again unless the layer is destroyed and re-created.
	 */
